...
mooring_locations$NRScolour <- ifelse(mooring_locations$NRS == FALSE, "blue", "red")
mooring_locations$NRSsize <- ifelse(mooring_locations$NRS == FALSE, 5, 10)

## Map the mooring locations using leaflet. Color the markers by NRS field
leaflet(mooring_locations) |>
  addTiles() |>
